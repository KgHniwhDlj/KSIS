...
class Tracert
{
    ...
    static void Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                Console.WriteLine("Не удалось разрешить DNS-имя или IP-адрес.");
                return;
            }
        ...
        {
            Console.WriteLine($"Ошибка при разрешении DNS-имени или IP-адреса: {ex.Message}");
            return;
        }

        Console.WriteLine($"Трассировка маршрута к {target} [{targetAddress}] с максимальным числом прыжков {maxHops}:");
